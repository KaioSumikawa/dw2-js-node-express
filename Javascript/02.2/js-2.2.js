...
document.write(`<p>Nosso vetor numbers é: ${numbers}</p>`)
...
let numbersOrdenado = numbers.sort((a, b) => a - b) // Ordenação numérica correta
document.write(`<p>O vetor numbers ordenado é: ${numbersOrdenado}</p>`)

document.write(`<p>O vetor de frutas ordenado é: ${vetor.sort()}</p>`)
