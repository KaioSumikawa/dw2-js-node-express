...
class Carro {
    ...
    constructor(marca, modelo, ano) {
        ...
        // O valor que for enviado à classe será atribuído à instância
        // ATRIBUTOS
        this.marca = marca;
        this.modelo = modelo;
        this.ano = ano;
...
// Correção: passando os parâmetros para o construtor
...
document.write(
    `<p>O carro ${carroEsportivo.marca} ${carroEsportivo.modelo} também possui neon da cor ${carroEsportivo.corNeon}. E quando usa turbo: ${carroEsportivo.turbo()}</p>`
);